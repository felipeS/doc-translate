...
export function checkTranslationQuality(
  ...
  const germanWordPattern = /\b(der|die|das|ein|eine|und|oder|aber|nicht|ist|sein|haben|werden|können|müssen|sollen|wollen|dürfen|mit|von|auf|für|zu|als|bei|aus|nach|um|an|im|am|des|dem|den|eing|über|unter|vor|hinter|zwischen|durch|ohne|gegen|auch|noch|schon|sehr|gut|biss|alles|nichts|etwas|jeder|dieser|jener|alle|einige|wenige|viele|andere|neue|alt|groß|klein|lang|kurz|erste|letzte|allein|immer|nie|heute|morgen|gestern|jetzt|damals|nun|da|wo|wie|warum|weil|damit|obwohl|ob|wenn|falls|sonst|bis|seit|während|bevor|nachdem|denn|doch|ja|nein|freilich|gewiß|leider|zwar|etwa|gar|nur|bloß|eben|halt|genau|besonders|ziemlich|recht|ganz|fast|kaum|ungefähr|circa|ca|merkmale|diener|gemeinde|christi|abschnitt|paulus|herr|gott|jesus|christus|gläubigen|schrift|bibel|brief|vers|erste|andere|weitere|nächste|letzte|alle|mehrere|einigen|wollen|sollt|das|als|da|man|wer|was|ich|du|er|sie|es|mir|dir|ihm|ihr|uns|euch|ihnen|mich|dich|sich|mein|dein|sein|ihr|unser|euer|deren|dessen|deren|welche|welcher|welches)\b/gi
